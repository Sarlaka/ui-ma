 ...
 * @LastEditTime: 2021-02-18 17:00:30
 * @Description: 
 */
...
export function DragUserNode ({onMouseDown,title,color,iconUrl,group,type}){
  return (
    <div className="single_menu_icon" onMouseDown={onMouseDown} data-type={type} data-title={title} data-body-fill={color} data-group={group} data-icon-url={iconUrl}>
...
export function DragEventNode ({onMouseDown,title,color,iconUrl,group,type}) {
  return (
    <div className="single_menu_icon" onMouseDown={onMouseDown} data-type={type} data-title={title} data-body-fill={color} data-group={group} data-icon-url={iconUrl}>
...
export function DragActionNode ({onMouseDown,title,color,iconUrl,group,type}) {
  return (
    <div className="single_menu_icon" onMouseDown={onMouseDown} data-type={type} data-title={title} data-body-fill={color} data-group={group} data-icon-url={iconUrl}>
...
export function DragLogicNode ({onMouseDown,title,color,iconUrl,group,type}) {
  return (
    <div className="single_menu_icon" onMouseDown={onMouseDown} data-type={type} data-title={title} data-body-fill={color} data-group={group} data-icon-url={iconUrl}>
